...
class Ui_MainAnalyticsWindow(object):
    def setupUi(self, MainAnalyticsWindow):
        ...
        MainAnalyticsWindow.resize(1098, 730)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_video1.sizePolicy().hasHeightForWidth())
        self.label_video1.setSizePolicy(sizePolicy)
        self.label_video1.setMinimumSize(QtCore.QSize(250, 0))
