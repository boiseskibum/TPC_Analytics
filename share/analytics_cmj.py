...
#        print(athlete_filter[['col_timestamp_str']])
        ...
        output_filename = self.path_athlete_images + 'Impulse_graph.png'
        my_plot = jtpl.JT_plot('CMJ Impulse', 'Date', 'Impulse (N-s)', line_data)
        my_plot.save_to_file(output_filename)

        # ******************** Create ToV graph ***********************
        line_data = [{'x': mean_df['datetime_object'], 'y': mean_df['ToV'], 'label': 'ToV', 'color': jt_color1}]
        output_filename = self.path_athlete_images + 'ToV_graph.png'
        ...
        output_filename = self.path_athlete_images + 'RSI_graph.png'
        ...
        output_filename = self.path_athlete_images + 'jump_time_graph.png'
        ...
        output_filename = self.path_athlete_images + 'CoM_displacement_graph.png'
        ...
        line_data = [{'x': mean_df['datetime_object'], 'y': mean_df['force_right'], 'label': 'Force Right',
                     ...
                     {'x': mean_df['datetime_object'], 'y': mean_df['force_left'], 'label': 'Force Left',
                      'color': jt_color2}]
        output_filename = self.path_athlete_images + 'force_comparison_graph.png'
        ...
        output_filename = self.path_athlete_images + 'force_asymmetry_graph.png'
        ...
        output_filename = self.path_athlete_images + 'unloading_impulse_graph.png'
        ...
        line_data = [
            ...
            {'x': mean_df['datetime_object'], 'y': mean_df['unloading_force_left'], 'label': 'Force Left',
             'color': jt_color2}]
        output_filename = self.path_athlete_images + 'sl_unloading_force_graph.png'
        ...
        output_filename = self.path_athlete_images + 'unloading_force_asymmetry_graph.png'
        ...
        output_filename = self.path_athlete_images + 'braking_impulse_graph.png'
        ...
        line_data = [{'x': mean_df['datetime_object'], 'y': mean_df['braking_force_right'], 'label': 'Force Right',
                     ...
                     {'x': mean_df['datetime_object'], 'y': mean_df['braking_force_left'], 'label': 'Force Left',
                      'color': jt_color2}]
        output_filename = self.path_athlete_images + 'sl_braking_force_graph.png'
        ...
        line_data = [{'x': mean_df['datetime_object'], 'y': mean_df['braking_force_asymmetry_index'],
                      'label': 'Asymmetry Index', 'color': jt_color1}]
        output_filename = self.path_athlete_images + 'braking_force_asymmetry_graph.png'
        ...
        output_filename = self.path_athlete_images + 'concentric_impulse_graph.png'
        ...
        line_data = [
            ...
            {'x': mean_df['datetime_object'], 'y': mean_df['concentric_force_left'], 'label': 'Force Left',
             'color': jt_color2}]
        output_filename = self.path_athlete_images + 'sl_concentric_force_graph.png'
        ...
        line_data = [{'x': mean_df['datetime_object'], 'y': mean_df['concentric_force_asymmetry_index'],
                      'label': 'Asymmetry Index', 'color': jt_color1}]
        output_filename = self.path_athlete_images + 'concentric_force_asymmetry_graph.png'
        ...
        output_filename = self.path_athlete_images + 'mean_power_graph.png'
...
#                self.cell(0, 10, f"Page {self.page_no()}/{{nb}}", align="C", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
    ...
    # code to create header and footer
    # Documentation here: https://pyfpdf.github.io/fpdf2/Tutorial.html
    def create_athlete_advanced_pdf(self):
        today_date = date.today()
        logo = self.config_obj.resources + "jt.png"
        if not os.path.exists(logo):
            logo = "jt.png"
        ...
        # row 1
        pdf.image(self.path_athlete_images + 'braking_impulse_graph.png',
                  x=x_start, y=y_start, w=image_w,
                  h=0)  # 0 for height allows image to scale, with value it will squish or fatten the image

        pdf.image(self.path_athlete_images + 'braking_force_asymmetry_graph.png',
                  x=half_pw, y=y_start, w=image_w, h=0)

        # row 2
        y_start += image_h
        pdf.image(self.path_athlete_images + 'concentric_impulse_graph.png',
                  x=x_start, y=y_start, w=image_w, h=0)

        pdf.image(self.path_athlete_images + 'concentric_force_asymmetry_graph.png',
                  x=half_pw, y=y_start, w=image_w, h=0)

        # row 3
        y_start += image_h
        pdf.image(self.path_athlete_images + 'mean_power_graph.png',
                  x=x_start, y=y_start, w=image_w, h=0)

        pdf.image(self.path_athlete_images + 'peak_power_graph.png',
                  x=half_pw, y=y_start, w=image_w, h=0)
...
if __name__ == "__main__":
    ...
    my_pdf = JT_analytics_cmj(config_obj, 'huey')
